...
const useStyles = makeStyles(({ palette, ...theme }) => ({
  ...
  cardLeft: {
    background: "#000 url(/assets/images/bg-3.png) no-repeat",
...
const AdminLogin = () => {
  ...
  const handleChange = ({ target: { name, value } }) => {
    ...
    temp[name] = value;
    setUserInfo(temp);
    // console.log('userInfooooooooo',userInfo)
  };
        ...
        <Card className={classes.card}>
          <Grid container>
              ...
              >
                <div className={classes.logo}>
                  {/* <MatxLogo className="mr-2" />{' '}
                                <span>MatX Pro</span> */}
                  <img height="45px" src="/logo.jpeg" alt="Dumkol Logo" />
                  <div>
                <h1 className={classes.mainTitle}>Admin Panel</h1>
                </div>
                </div>
            ...
            <Grid item lg={6} md={6} sm={6} xs={12}>
              ...
              <div style={{border: '5px solid #ffeb00'}} className="p-8 h-full relative">
                <ValidatorForm onSubmit={handleFormSubmit}>
                  ...
                  <div className="flex flex-wrap items-center mb-4">
                    <div className="relative">
                      <Button style={{backgroundColor:'#ffeb00'}} variant="contained" color="#ffeb00" disabled={loading} type="submit">
                        Sign in
                      </Button>
