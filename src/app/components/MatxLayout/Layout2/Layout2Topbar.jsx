...
import { MatxMenu, MatxToolbarMenu, MatxSearchBox } from "../../index";
    ...
    <div className={clsx("relative w-full", classes.root)}>
      <div className="flex justify-between items-center h-full">
        <div className="flex items-center h-full">
          <img className="h-32" src="/assets/images/logo.svg" alt="company-logo" />
          <span className={clsx("font-medium text-24 mx-4", classes.brandText)}>Matx</span>
        </div>
        ...
        <div className="flex items-center">
          <MatxToolbarMenu offsetTop="64px">
            ...
            <MatxMenu menuButton={<Avatar className="cursor-pointer mx-2" src={user.avatar} />}>
