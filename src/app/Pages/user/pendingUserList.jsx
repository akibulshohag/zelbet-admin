    ...
    const fetchData = async () => {
      try {
        ...
        let res = await axios.get(
          `/admin/users/pending?pageNo=${page + 1}&perPage=${rowsPerPage}`
        );
  ...
  return (
    <div className="m-sm-30">
      <div className="mb-sm-30">
        <Breadcrumb routeSegments={[{ name: "Pending User List" }]} />
      </div>

      <Grid container>
        <Grid item xs={12}>
          <Card elevation={3}>
            <CardHeader title="Pending Users" />
                      ...
                      <Table stickyHeader className="whitespace-pre">
                        ...
                        <TableBody>
                          {dataList.map((data, index) => (
                            ...
                            >
                              <p style={{ fontSize: "14px",marginBottom:3 }}>Verify</p>
                            </div>
                            <div
                              onClick={() => {
                                setIsOpenModal(true);
                                setDeleteId(data?.userId);
                                setstatusSave("suspended");
                              }}
                              style={{
                                backgroundColor: "red",
                                color: "#fff",                               
